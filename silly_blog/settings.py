...
SECRET_KEY = '=#k-vp*0hxgr68utfjjznp1^0xqt7bm$zu-4km&=q6#ww7a3z3'
...
ROOT_URLCONF = 'silly_blog.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'silly_blog.wsgi.application'
